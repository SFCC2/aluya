...
import servicios.BDinventario;

/**
 *
 * @author Labing I5
 */
public class ListaInventario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<InventarioVO> inventarios = bd.getInventario();
            String box = "* {\n"
            ...
            for (InventarioVO inventario : inventarios) {
                content.append(""
                        ...
                        + "<td>" + inventario.getAreaTrabajo()+ "</td>\n"
