...
import servicios.BDproyecto;

/**
 *
 * @author Labing I5
 */
public class ListaProyecto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            BDproyecto bd = new BDproyecto();
            ArrayList<ProyectoVO> proyectos = bd.getproyectos();
            String box = "* {\n"
            ...
            for (ProyectoVO proyecto : proyectos) {
                content.append(""
                        + "<tr>\n"
                        + "<td>" + proyecto.getIdArchivo() + "</td>\n"
                        + "<td>" + proyecto.getNombre(proyecto.getIdArchivo(), proyecto.getIdEmpresa(),
                                proyecto.getIdArchivo(), proyecto.getFechaRealizada()) + "</td>\n"
                        + "<td>" + proyecto.getIdEmpresa() + "</td>\n"
                        + "<td>" + proyecto.getIdArchivo() + "</td>\n"
                        + "<td>" + proyecto.getFechaRealizada() + "</td>\n"
                        + "</tr>\n");
            }
            content.append(""
                    + "</tbody>\n"
